    ...
    <div className="min-h-screen flex w-full">
      ...
      <div className="hidden md:flex md:w-1/2 relative flex-col items-center justify-center overflow-hidden bg-surface-page">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-8 max-w-md">
          ...
          <motion.p
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={shouldReduceMotion ? { duration: 0 } : { duration: 0.5, delay: 0.25, ease: "easeOut" }}
              ...
              return (
                <motion.div
                  ...
                  transition={
                    shouldReduceMotion
                      ? { duration: 0 }
                      : { duration: 0.5, delay: 0.5 + index * 0.1, ease: "easeOut" }
                  }
                  className="flex items-center gap-3 text-left"
                >
                  <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-brand-100 flex items-center justify-center">
                    <Icon className="size-[18px] text-brand-500" strokeWidth={1.5} />
                  </div>
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center bg-surface-page px-4 py-12">
          ...
          <div className="bg-surface-card border border-border-default rounded-2xl p-8">
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-text-secondary">Sign in to start studying</p>
              </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-text-tertiary">Built for students to study effectively</p>
          <p className="mt-1 text-xs text-text-tertiary">AI-powered learning for better retention and performance</p>
        </div>
      </div>
    </div>
  )
