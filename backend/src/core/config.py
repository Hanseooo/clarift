...
class Settings(BaseSettings):
    ...
    CHAT_SYSTEM_PROMPT: str = (
        ...
        "the tags.\n\n"
        "<answer>\n"
        "[Your markdown-formatted answer. Use headings, bullet points, bold text, and inline code "
        "for readability. Place citation markers [N] only next to facts taken from the chunks.]\n"
        "</answer>\n\n"
        "<used_citations>\n"
